...
import { Globe, Mail, Twitter, Facebook, Instagram } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              ...
              <li><Link href="/category/Business" className="hover:text-accent transition-colors">Business & Economy</Link></li>
              <li><Link href="/category/Technology" className="hover:text-accent transition-colors">Technology</Link></li>
              <li><Link href="/category/Society" className="hover:text-accent transition-colors">Society & Culture</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/80">
              <li><Link href="/country/Nigeria" className="hover:text-accent transition-colors">West Africa</Link></li>
              <li><Link href="/country/Kenya" className="hover:text-accent transition-colors">East Africa</Link></li>
              <li><Link href="/country/South Africa" className="hover:text-accent transition-colors">Southern Africa</Link></li>
              <li><Link href="/country/Egypt" className="hover:text-accent transition-colors">North Africa</Link></li>
          ...
          <div>
            ...
            <p className="text-sm text-primary-foreground/70 mb-4">Get the top stories delivered to your inbox daily.</p>
            <form className="flex flex-col gap-2" onSubmit={e => { e.preventDefault(); toast({title: "Subscribed!", description: "Thanks for joining our newsletter."})}}>
              ...
              <Button type="submit" className="w-full bg-accent hover:bg-accent/90 text-white border-none shadow-none">
                Subscribe
              </Button>
            </form>
          </div>
